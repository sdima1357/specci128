...
{
	if(f_open(&MyFile1,(TCHAR*)fileName, FA_READ)==FR_OK)
	{
		ifs_tape = &MyFile1;
...
int  tapeBit()
{
	...
	int64_t delta = (tstates - TapeState.prevT)+(getFrameCounter()-TapeState.prevT_frame)*getT69888();
